...
class CreateTripPage extends StatelessWidget {
  ...
  CreateTripPage({Key? key,
    required this.startingPoint,
      required this.endingPoint}) : super(key: key);

  final priceController = TextEditingController();

  void createTrip(String start, String end, String? vehicle, int? price) async{
            ...
            return Column(
              ...
              children: [
                ...
                Center(
                  child: MyButton(
                    text: "Crear Viaje", 
                    onTap: () => createTrip(startingPoint, endingPoint, tripPlate, int.tryParse(priceController.text)),
                  ),
                ),
              ],
            );
